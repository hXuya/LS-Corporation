<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectMilestone.aspx.cs" Inherits="LS_Corporation.ComplexWebForm.ProjectMilestone" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            <h2 class="mb-4 pb-2 border-bottom">Project Milestone Details</h2>
            ...
            <div class="table-responsive mb-4">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="PROJECTSTARTDATE" HeaderText="Project Start" SortExpression="PROJECTSTARTDATE" DataFormatString="{0:MM/dd/yyyy}" />
                        <asp:BoundField DataField="PROJECTDUEDATE" HeaderText="Project Due" SortExpression="PROJECTDUEDATE" DataFormatString="{0:MM/dd/yyyy}" />
                        ...
                        <asp:BoundField DataField="MILESTONESTARTDATE" HeaderText="Milestone Start" SortExpression="MILESTONESTARTDATE" DataFormatString="{0:MM/dd/yyyy}" />
                        <asp:BoundField DataField="MILESTONEDUEDATE" HeaderText="Milestone Due" SortExpression="MILESTONEDUEDATE" DataFormatString="{0:MM/dd/yyyy}" />
                        <asp:BoundField DataField="MILESTONESTATUS" HeaderText="Milestone Status" SortExpression="MILESTONESTATUS" />
                    </Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                ORDER BY p.ProjectId, m.MilestoneStartDate">
                <SelectParameters>
