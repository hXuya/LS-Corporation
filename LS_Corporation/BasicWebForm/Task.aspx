<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Task.aspx.cs" Inherits="LS_Corporation.BasicWebForm.Task" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item active" href="Task.aspx">Task Details</a></li>
        ...
        <div class="container">
            <h2 class="mb-4 pb-2 border-bottom">Task Details</h2>
            
            <div class="table-responsive mb-4">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="TASKID" DataSourceID="SqlDataSource1" AllowPaging="True"
                    ...
                    <Columns>
                        <asp:TemplateField ItemStyle-Width="100px">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="DeleteButton" runat="server" CommandName="Delete" CssClass="btn btn-sm btn-outline-danger" ToolTip="Delete"
                                    OnClientClick="return confirm('Delete this task?');">
                        ...
                        <asp:BoundField DataField="TASKSTARTDATE" HeaderText="Start Date" SortExpression="TASKSTARTDATE" DataFormatString="{0:MM/dd/yyyy}" />
                        <asp:BoundField DataField="TASKDUEDATE" HeaderText="Due Date" SortExpression="TASKDUEDATE" DataFormatString="{0:MM/dd/yyyy}" />
                    ...
                    <EditItemTemplate>
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:DropDownList ID="TASKSTATUSDropDownList" runat="server" CssClass="form-select" SelectedValue='<%# Bind("TASKSTATUS") %>'>
                    ...
                    <ItemTemplate>
                        <div class="text-center">
                            <asp:LinkButton ID="NewButton" runat="server" CommandName="New" CssClass="btn btn-success">
                                <i class="fas fa-tasks me-1"></i> Add New Task
                            </asp:LinkButton>
                        </div>
                    </ItemTemplate>
                </asp:FormView>
