<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Project.aspx.cs" Inherits="LS_Corporation.BasicWebForm.Project" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item active" href="Project.aspx">Project Details</a></li>
        ...
        <div class="container">
            <h2 class="mb-4 pb-2 border-bottom">Project Details</h2>
            
            <div class="table-responsive mb-4">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="PROJECTID" DataSourceID="SqlDataSource1" AllowPaging="True"
                    ...
                    <EditItemTemplate>
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:DropDownList ID="PROJECTSTATUSDropDownList" runat="server" CssClass="form-select" SelectedValue='<%# Bind("PROJECTSTATUS") %>'>
                    ...
                    <ItemTemplate>
                        <div class="text-center">
                            <asp:LinkButton ID="NewButton" runat="server" CommandName="New" CssClass="btn btn-success">
                                <i class="fas fa-folder-plus me-1"></i> Add New Project
                            </asp:LinkButton>
                        </div>
                    </ItemTemplate>
                </asp:FormView>
